...
// modulo symbol -- % -- calculates the remainder (3 % 2 = 1) if(number %16 == 0) 
namespace Week1Practice
{
                ...
                while (int i <= 10)
	{
            ...
            int i = 0;
            while(int i <= 10; i % 4 = 0){
                return i % 4 = 0;
            }

            // PUTTING IT TOGETHER //took a stab at it
            ...
            Console.WriteLine(New Greeting(myName));
        ...
        static int SuperLoop(int startNum, int endNum, int increment) {
            int LoopCount = 0;
            ...
            //      This function will print out: // Create a function called "SuperLoop" that takes three integer parameters called "startNum", "endNum", and "increment".  
            //      You will need to track how many times the loop has been executed in a variable called "loopCount".
            //      This function will print out: 
            //          a. "I'm looping from <startNum> to <endNum>, incrementing <increment> each time"  
            //          b. The numbers from startNum to endNum, one per line.
        ...
        static int TripleIt( int number) {return number * 3;}

        static int RealMultiply(int num1, int num2) {return num1 * num2;}
    }
}
